...
def fire():
            ...
            if 'time' in fire:                            #time
            ...
            elif 'open google' in fire:    
                speak('Opening..')            #google
                webbrowser.open("google.com")
    
            elif 'open youtube' in fire: 
                ...
                resqu=str(query)
                driver.get("https://www.google.com/search?".join(resqu))
                ...
                print("You told me remember"+remember.read())

            elif 'screenshot'  in fire:                                                    #screenshot
                screenshot()
                speak("Screenshot Taken")

            elif 'CPU'in fire or 'Battery' in fire or 'system details' in fire or 'cpu' in fire:                 #cpu
                cpu()
                ...
                maps_arg = webbrowser.get('C:/Program Files (x86)/Google/Chrome/Application/chrome.exe').open ("https://www.google.com/maps/?".join(location_url))
                os.system(maps_arg)
